<?php
    ...
    {
        $token = $_COOKIE['token'];
        $query = "select id, email, type from users where token='$token'";
        ...
        if(isset($_POST['incarca']))
        {
            ...
            // echo $creator_id;
            $query = "insert into locatii (titlu, pret, locatie, suprafata,servicii, capacitate, id_creator) 
                        VALUES ('$titlu', '$pret', '$locatie', '$suprafata', '$servicii', '$capacitate', '$id_creator')";

            mysqli_query($conn, $query);

            $query = "select count(id) from locatii";
            $result = mysqli_query($conn, $query);
            $count = mysqli_fetch_assoc($result)['count(id)'];
                        ...
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                ...
                                <div class="widget-content-right header-user-info ml-3">
                                    <button type="button"
                                        class="btn-shadow p-1 btn btn-primary btn-sm" onClick="window.location.replace('./index.php');">
                                        <i class="fa text-white fa-home pr-1 pl-1"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="./dashboard_locatie.php" class="mm-active">
                            ...
                            <form method="POST">
                                <li>
                                    <a href="./index.php">
                                        <i class="fa-solid fa-right-from-bracket" style="padding-right: 10px"></i>
                    ...
                    <div class="container">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" id="titlu" name="titlu">
                                    </div>
                                </div>
                                <!--  col-md-6   -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="pret">Pret / noapte</label>
                                        <input type="number" class="form-control" placeholder="" id="pret" name="pret">
                                    </div>
                                </div>
                                <!--  col-md-6   -->
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" id="locatie" name="locatie">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="servicii" name="servicii">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="capacitate" name="capacitate">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <div class="col-lg-3 col-sm-6 col-12 mb-5 text-center" style="padding-left: 0; margin: auto">
                                    <p>Adauga poze pentru locatie</p>
                                    <span class="file-input btn btn-block btn-primary btn-file">
                                        Browse&hellip; <input type="file" name="image[]" multiple>
                                    </span>
                                </div>

                                <button type="submit" class="btn btn-success" name="incarca">Incarca</button>
                            </div>
                        </form>
                    </div>
                </div>
